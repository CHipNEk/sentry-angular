...
function init(options) {
    const opts = Object.assign({ defaultIntegrations: getDefaultIntegrations() }, options);
            ...
            if (client) {
                ...
                this._routingSpan =
                    runOutsideAngular(() => startInactiveSpan({
                        ...
                        attributes: Object.assign({ [SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN]: 'auto.ui.angular', [SEMANTIC_ATTRIBUTE_SENTRY_SOURCE]: 'url', url: strippedUrl }, (navigationEvent.navigationTrigger && {
